...
#                "CAEC", "SMOKE", "SCC", "CALC", "MTRANS", "FAF", "TUE", "CH2O", "NCP", "FCVC")
...
# Create JAGS model
model <- jags.model("new_model.bug", data = jags_data, inits = inits, n.chains = 3)

# Burn-in period
#update(model, 1000)

# Sample from posterior
samples <- coda.samples(model, variable.names = c("beta0", "beta", "u", "sigma2", "tau2"), n.iter = 5000)
```
