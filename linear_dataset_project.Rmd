...
train_ratio <- 0.8
train_indices <- sample(seq_len(nrow(obesity_data)), size = floor(train_ratio * nrow(obesity_data)))

train_data <- obesity_data[train_indices, ]
test_data <- obesity_data[-train_indices, ]

# Just to confirm sizes
...
columns_to_scale <- setdiff(names(obesity_data), c("Age", "BMI_cont", "BMI_squared", "group", "MTRANS"))
